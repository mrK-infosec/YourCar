  ...
  return (
    <div
      className={`flex flex-col items-center justify-center space-y-4 animate-fade-in ${
        fullPage ? 'fixed inset-0 z-50 bg-brand-dark bg-opacity-95' : 'w-full py-12'
      }`}
    >
      <div className="relative flex items-center justify-center">
        {/* Neon Outer Glowing Ring */}
        <div className="w-16 h-16 rounded-full border-2 border-brand-red border-opacity-10 border-t-brand-red animate-spin shadow-[0_0_15px_rgba(102,252,241,0.2)]"></div>
        ...
        <div className="absolute text-brand-red animate-pulse-subtle">
